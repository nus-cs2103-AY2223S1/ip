...
public class EventTest {
    ...
    public void saveFormat_saveFormatConversion_success() {
        Event t1 = new Event("task1", LocalDateTime.of(2000,
                12, 14, 5, 30), Priority.HIGH);
        Event t2 = new Event("task2", LocalDateTime.of(2022,
                12, 14, 23, 59), Priority.LOW);
        t1.markDone();
        assertEquals("E | high | 1 | task1 | Dec 14 2000 0530", t1.saveFormat());
        assertEquals("E | low | 0 | task2 | Dec 14 2022 2359", t2.saveFormat());
    }
}
