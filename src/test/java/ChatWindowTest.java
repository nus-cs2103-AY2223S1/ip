...
public class ChatWindowTest {
    ...
    private static final String VERY_LONG_TEXT = "This is a very long text that will make it very likely to "
            + "wrap across multiple lines. Moreover, this text contains multiple sentences.";
