...
public class ParserTest {
    ...
    public void parse_blankString_exceptionThrown() {
        Exception e1 = assertThrows(MortException.class, () -> Parser.parse(""));
        Exception e2 = assertThrows(MortException.class, () -> Parser.parse("   "));
    ...
    public void parse_pipeCharacter_exceptionThrown() {
        Exception e1 = assertThrows(MortException.class, () ->
                Parser.parse("deadline spanish | homework /by 31/12/2022"));

        Exception e2 = assertThrows(MortException.class, () ->
                Parser.parse("event birthday | party /at 31/12/2022"));

        Exception e3 = assertThrows(MortException.class, () -> Parser.parse("todo read| a book"));
    ...
    public void parse_unknownCommand_exceptionThrown() {
        Exception e1 = assertThrows(MortException.class, () -> Parser.parse("random word"));
        Exception e2 = assertThrows(MortException.class, () -> Parser.parse("list sss"));
        Exception e3 = assertThrows(MortException.class, () -> Parser.parse("bye asda"));
        String msg = " is not a valid command.\nIf you want my help, the least you could do is say "
    ...
    public void parse_emptyFindKeyword_exceptionThrown() {
        Exception e1 = assertThrows(MortException.class, () -> Parser.parse("find"));
        Exception e2 = assertThrows(MortException.class, () -> Parser.parse("find "));
        Exception e3 = assertThrows(MortException.class, () -> Parser.parse("find  "));
    ...
    public void parse_wrongNumberFormat_exceptionThrown() {
        ...
        Exception e2 = assertThrows(MortException.class, () -> Parser.parse("mark a2a"));
        Exception e3 = assertThrows(MortException.class, () -> Parser.parse("unmark _3df"));
    ...
    public void parse_missingTaskNumber_exceptionThrown() {
        Exception e1 = assertThrows(MortException.class, () -> Parser.parse("mark  "));
        Exception e2 = assertThrows(MortException.class, () -> Parser.parse("unmark  "));
        Exception e3 = assertThrows(MortException.class, () -> Parser.parse("delete  "));
        Exception e4 = assertThrows(MortException.class, () -> Parser.parse("mark"));
        Exception e5 = assertThrows(MortException.class, () -> Parser.parse("unmark"));
        Exception e6 = assertThrows(MortException.class, () -> Parser.parse("delete"));
    ...
    public void parse_blankToDoDescription_exceptionThrown() {
        Exception e1 = assertThrows(MortException.class, () -> Parser.parse("todo"));
        Exception e2 = assertThrows(MortException.class, () -> Parser.parse("todo "));
        Exception e3 = assertThrows(MortException.class, () -> Parser.parse("todo  "));
    ...
    public void parse_blankEventDescription_exceptionThrown() {
        Exception e1 = assertThrows(MortException.class, () -> Parser.parse("event"));
        Exception e2 = assertThrows(MortException.class, () -> Parser.parse("event "));
        Exception e3 = assertThrows(MortException.class, () -> Parser.parse("event  "));
        Exception e4 = assertThrows(MortException.class, () -> Parser.parse("event /at 1/1/2022 1630"));
        Exception e5 = assertThrows(MortException.class, () -> Parser.parse("event  /at 1/1/2022 1630"));
        Exception e6 = assertThrows(MortException.class, () -> Parser.parse("event /at Sunday"));
        String expected = "It seems you've invented a way to do nothing. Typical...\n"
    ...
    public void parse_blankDeadlineDescription_exceptionThrown() {
        Exception e1 = assertThrows(MortException.class, () -> Parser.parse("deadline"));
        Exception e2 = assertThrows(MortException.class, () -> Parser.parse("deadline "));
        Exception e3 = assertThrows(MortException.class, () -> Parser.parse("deadline  "));
        Exception e4 = assertThrows(MortException.class, () -> Parser.parse("deadline /by 1/1/2022 1630"));
        Exception e5 = assertThrows(MortException.class, () -> Parser.parse("deadline  /by 1/1/2022 1630"));
        Exception e6 = assertThrows(MortException.class, () -> Parser.parse("deadline /by Sunday"));
        String expected = "It seems you've invented a way to do nothing. Typical...\n"
    ...
    public void parse_missingDeadlineDateTime_exceptionThrown() {
        Exception e1 = assertThrows(MortException.class, () -> Parser.parse("deadline / by 1/4/2022 0815"));
        Exception e2 = assertThrows(MortException.class, () -> Parser.parse("deadline spanish homework"));
        Exception e3 = assertThrows(MortException.class, () -> Parser.parse("deadline spanish homework "));
        Exception e4 = assertThrows(MortException.class, () -> Parser.parse("deadline spanish homework  "));
        Exception e5 = assertThrows(MortException.class, () -> Parser.parse("deadline spanish homework/by"));
        Exception e6 = assertThrows(MortException.class, () ->
                Parser.parse("deadline spanish homework /by"));
        Exception e7 = assertThrows(MortException.class, () ->
                Parser.parse("deadline spanish homework /by "));
    ...
    public void parse_missingEventDateTime_exceptionThrown() {
        Exception e1 = assertThrows(MortException.class, () -> Parser.parse("event / at 1/4/2022 0815"));
        Exception e2 = assertThrows(MortException.class, () -> Parser.parse("event project meeting"));
        Exception e3 = assertThrows(MortException.class, () -> Parser.parse("event project meeting "));
        Exception e4 = assertThrows(MortException.class, () -> Parser.parse("event project meeting  "));
        Exception e5 = assertThrows(MortException.class, () -> Parser.parse("event project meeting/at"));
        Exception e6 = assertThrows(MortException.class, () -> Parser.parse("event project meeting /at"));
        Exception e7 = assertThrows(MortException.class, () -> Parser.parse("event project meeting /at "));
        String expected = "You do realise deadlines and events usually have a time or date, right?\n"
                + "Type \"event <description> /at <date> <time>[optional]\" to add a new event.";
    ...
    @Test
    public void convertStringToDateTime_acceptedFormat_success() throws MortException {
    ...
    @Test
    public void convertStringToDate_acceptedFormat_success() throws MortException {
    ...
    public void convertStringToDateTime_invalidDateTime_exceptionThrown() {
        ...
        Exception e3 = assertThrows(MortException.class, () ->
                Parser.convertStringToDateTime("1/4/2022  1600"));

        Exception e4 = assertThrows(MortException.class, () ->
                Parser.convertStringToDateTime("1 Apr 2022 1600"));

        Exception e5 = assertThrows(MortException.class, () ->
    ...
    public void convertStringToDate_invalidDate_exceptionThrown() {
        Exception e1 = assertThrows(MortException.class, () -> Parser.convertStringToDate("1-4-2022"));
        Exception e2 = assertThrows(MortException.class, () -> Parser.convertStringToDate("1/4/22"));
        Exception e3 = assertThrows(MortException.class, () -> Parser.convertStringToDate("32/4/2022"));
        Exception e4 = assertThrows(MortException.class, () -> Parser.convertStringToDate("1/13/2022"));
        Exception e5 = assertThrows(MortException.class, () -> Parser.convertStringToDate("1 Apr 2022"));
