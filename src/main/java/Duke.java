    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // to do keyword: create new to do item
                ...
                data[dataIdx++] = new Todo(desc);
                System.out.println("Got it. I've added this task:");
                System.out.println("\t " + data[dataIdx - 1].toString());
                System.out.println("Now you have " + dataIdx + " tasks in the list");
            }
            // deadline keyword: create new deadline item
            else if (words[0].equals("deadline")) {
                String[] dl = input.split("/by");
                String desc = dl[0].split("deadline")[1];
                data[dataIdx++] = new Deadline(desc, dl[1]);
                System.out.println("Got it. I've added this task:");
                System.out.println("\t " + data[dataIdx - 1].toString());
                System.out.println("Now you have " + dataIdx + " tasks in the list");
            }
            // event keyword: create new event item
                ...
                data[dataIdx++] = new Event(desc, ev[1]);
                System.out.println("Got it. I've added this task:");
                System.out.println("\t " + data[dataIdx - 1].toString());
                System.out.println("Now you have " + dataIdx + " tasks in the list");
            }
