...
public class Sakura {
    ...
    private String Start(String input) {
        if (input.equals("bye")) {
            inProgress = false;
            return "\tBye Senpai! It was a pleasure serving you, see you again soon!";
    ...
    private String handleAdd(int index) {
        Task task = this.store.get(index - 1);
        int LEN = this.store.size();
        return String.format("\tYes Sir! I've added this task: \n\t %s \n\tNow you have %d tasks in the list.", task, LEN);
    }
