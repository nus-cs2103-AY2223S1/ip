...
import kohaku.daveexceptions.DaveInitFileException;
...
public class SaveHandler {
    ...
    protected void initFile(File file) throws DaveException {
        ...
        assert file.exists() : "The save file should exist";
    ...
    protected void write(TaskList tasks, File file) throws DaveException {
        try{
            ...
            throw new kohaku.daveexceptions.DaveException("Oh no! An error has been encountered while saving!");
        }
    }
    ...
    protected TaskList read(File file) throws DaveException {
        if (file.length() != 0) {
            try{
                ...
                throw new kohaku.daveexceptions.DaveException("Oh no! An error has been encountered while loading!");
            }
        } else {
            return new TaskList();
        }
