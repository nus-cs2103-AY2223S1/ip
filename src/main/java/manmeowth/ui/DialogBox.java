...
public class DialogBox extends HBox {
    ...
    /**
     * Returns DialogBox for the ManMeowth program's response.
     *
     * @param text ManMeowth's text response to the user.
     * @param img ManMeowth's avatar image.
     * @return DialogBox for the ManMeowth program's response.
     */
    public static DialogBox getManMeowthDialog(String text, Image img) {
