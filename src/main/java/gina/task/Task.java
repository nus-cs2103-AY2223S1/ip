...
public abstract class Task {
     ...
     * @throws GinaException If the wrong input or format is provided for the date.
     */
    public abstract boolean isOnThisDate(String dateStr) throws GinaException;

    public abstract boolean doesDescriptionContain(String input) throws GinaException;
