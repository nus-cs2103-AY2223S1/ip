...
/**
 * Represents a deadline with description, complete/incomplete status, and
 * deadline.
 */
public class Deadline extends Task {
  ...
  /**
   * Returns string representation of deadline to save in file (eg. deadline //
   * T // Do homework // 2022-12-07 12:00).
   * 
