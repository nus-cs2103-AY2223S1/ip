...
/**
 * Represents an event with description, complete/incomplete status, and time
 * interval.
 */
public class Event extends Task {
  ...
  /**
   * Returns string representation of event to save in file (eg. event //
   * T // Concert night // 2022-12-07 18:00).
   * 
