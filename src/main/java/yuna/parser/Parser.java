...
import yuna.command.AddCommand;
import yuna.command.Command;
import yuna.command.DeleteCommand;
import yuna.command.ExitCommand;
import yuna.command.FindCommand;
import yuna.command.ListCommand;
import yuna.command.MarkCommand;
import yuna.command.OnDateCommand;
import yuna.command.UnMarkCommand;
...
public abstract class Parser {
     ...
     * @throws YunaException There is an error in returning the command to run.
     */
    public static Command exitCommand(String[] inputArray) throws YunaException {
        if (inputArray.length == 1) {
            Command command = new ExitCommand();
            return command;
        } else {
            throw new YunaException(Parser.ERROR_UNKNOWN_MESSAGE);
        }
    }
     ...
     * @throws YunaException There is an error in returning the command to run.
     */
    public static Command listCommand(String[] inputArray) throws YunaException {
        if (inputArray.length == 1) {
     ...
     * @throws YunaException There is an error in returning the command to run.
     */
    public static Command markCommand(String[] inputArray) throws YunaException {
        String secondWord = "";
        if (inputArray.length == 2) {
            secondWord = inputArray[1];
        }
        if (secondWord.length() == 0) {
            throw new YunaException(Parser.ERROR_INVALID_MARK_NUMBER);
        }
        try {
     ...
     * @throws YunaException There is an error in returning the command to run.
     */
    public static Command unmarkCommand(String[] inputArray) throws YunaException {
        String secondWord = "";
        if (inputArray.length == 2) {
            secondWord = inputArray[1];
        }
        if (secondWord.length() == 0) {
            throw new YunaException(Parser.ERROR_INVALID_UNMARK_NUMBER);
        }
        try {
     ...
     * @throws YunaException There is an error in returning the command to run.
     */
    public static Command todoCommand(String[] inputArray) throws YunaException {
        String secondWord = "";
        if (inputArray.length == 2) {
            secondWord = inputArray[1];
        }
     ...
     * @throws YunaException There is an error in returning the command to run.
     */
    public static Command deadlineCommand(String[] inputArray) throws YunaException {
        String secondWord = "";
        if (inputArray.length == 2) {
            secondWord = inputArray[1];
        }
        try {
            ...
            if (dArray.length == 1) {
                throw new YunaException(Parser.ERROR_EMPTY_DATE);
            }
            ...
            throw new YunaException(Parser.ERROR_DATE_FORMAT);
        }
    }
     ...
     * @throws YunaException There is an error in returning the command to run.
     */
    public static Command eventCommand(String[] inputArray) throws YunaException {
        String secondWord = "";
        if (inputArray.length == 2) {
            secondWord = inputArray[1];
        }
     ...
     * @throws YunaException There is an error in returning the command to run.
     */
    public static Command deleteCommand(String[] inputArray) throws YunaException {
        String secondWord = "";
        if (inputArray.length == 2) {
            secondWord = inputArray[1];
        }
        if (secondWord.length() == 0) {
            throw new YunaException(Parser.ERROR_DELETE_NUMBER);
        }
        try {
     ...
     * @throws YunaException There is an error in returning the command to run.
     */
    public static Command onCommand(String[] inputArray) throws YunaException {
        String secondWord = "";
        if (inputArray.length == 2) {
            secondWord = inputArray[1];
        }
     ...
     * @throws YunaException There is an error in returning the command to run.
     */
    public static Command findCommand(String[] inputArray) throws YunaException {
        String secondWord = "";
        if (inputArray.length == 2) {
            secondWord = inputArray[1];
        }
     ...
     * @throws YunaException There is an error in returning the command to run.
     */
    public static Command parse(String input) throws YunaException {
        Command command;
