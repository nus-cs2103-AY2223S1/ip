...
public class Deadline extends Task {
     ...
     * @throws YunaException If date format is invalid.
     */
    public static Deadline parseFile(String data) throws YunaException {
        try {
            ...
            throw new YunaException("Invalid date format (yyyy-mm-dd)");
        }
    }
