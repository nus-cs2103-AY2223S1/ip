...
/**
 * UserInterface manages all the inputs from the user and outputs to the console
 */
public class UserInterface {
    ...
    /**
     * Requests a command in the form of a string from the user
     */
    ...
    /**
     * Advances the location of the current path
     * @param locationName the location name to advance to
     */
    ...
    /**
     * Retreats from the previously advanced location
     */
    ...
    /**
     * Prints the current location the user is at
     */
     ...
     * @param others the strings to print
     */
    public static void printInStyle(Object[] itemsToPrint, String... others) {
        System.out.println(DECORATOR);
        for (Object item : itemsToPrint) {
            System.out.println("\t\t" + item.toString());
        }
