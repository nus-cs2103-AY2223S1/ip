...
/**
 * SelectTaskListsCommand is a menu page that allows the user to select a task list
 * from the currently available task lists, or perform auxiliary actions related to
 * task lists like deleting and adding new ones.
 */
