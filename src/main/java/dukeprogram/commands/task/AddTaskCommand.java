...
/**
 * AddTaskCommand is capable of adding a new task to the current task list
 * only if a valid string that describes the task type, task name and extra
 * parameters are provided to be parsed. As a standalone command, it will not
