...
/**
 * An invalid task number exception for the CatBot chatbot which extends from CatBotException.
 */
public class InvalidTaskNumberException extends CatBotException {
