...
public class Deadline extends Task {
     ...
     * @throws VioletException If by is in an invalid format.
     */
    public Deadline(String description, String by) throws VioletException {
        super(description);
        this.by = by;
        try {
            this.deadline = LocalDateTime.parse(by.substring(1));
        } catch (DateTimeParseException e) {
            throw new VioletException("Please input the deadline in yyyy-mm-ddTHours:Minute:Seconds format. "
     ...
     * @throws VioletException If by is in an invalid format.
     */
    public Deadline(String description, boolean isDone, String by) throws VioletException {
