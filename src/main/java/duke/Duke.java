...
static final String filePath = "tasks.txt";
    ...
    private Image user = new Image(this.getClass().getResourceAsStream("/images/ernie.jpg"));
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/bert.jpg"));
    /**
