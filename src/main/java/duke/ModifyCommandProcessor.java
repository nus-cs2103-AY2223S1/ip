...
public class ModifyCommandProcessor {
    private final static String STATUS_COMPLETE = "done";
    private final static String STATUS_INCOMPLETE = "not done";
    ...
    protected static String processModifyCommand(String keyword, String content, TaskList tasks, Ui ui) {
        ...
        if (keyword.equals("mark")) {
            ...
            return ui.updateTask(updatedTask, STATUS_COMPLETE);
        } else if (keyword.equals("unmark")) {
            Task updatedTask = tasks.unmarkTask(index);
            return ui.updateTask(updatedTask, STATUS_INCOMPLETE);
        } else {
