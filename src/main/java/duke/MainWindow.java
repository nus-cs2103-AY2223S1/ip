...
/**
 * Controller for MainWindow such that logic in Duke not affected by UI.
 */
public class MainWindow extends AnchorPane {
    ...
    /**
     * Method to Initialize Duke and its image.
     */
    @FXML
