...
public class Ui {
    ...
    /**
     * Returns the hello introduction message for Duke.
     *
     * @return The hello introduction message for Duke.
     */
    ...
    /**
     * Returns the exit program message for Duke.
     *
     * @return The exit program message for Duke.
     */
