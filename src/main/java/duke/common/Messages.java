...
public class Messages {
    ...
    public static final String MESSAGE_TASK_ADDED = "Sure! Task added:\n  ";
    public static final String MESSAGE_TASK_REMOVED = "Alright! Task removed:\n  ";
    public static final String MESSAGE_TASK_DONE = "Speedy, keep it up!\n\nTask marked as done:\n  ";
    public static final String MESSAGE_TASK_NOT_DONE = "Welp, don't fall behind!\n\nTask marked as not done:\n  ";
    public static final String MESSAGE_TASK_LIST = "Here's your task list:\n";
    ...
    public static final String MESSAGE_NO_SUCH_TASK = "Are you sure about that? There is no such task!";
    ...
    public static final String MESSAGE_MATCHING_TASKS = "Aha, found them!\n\nHere are your matching task(s):\n";
    public static final String MESSAGE_NO_MATCHING_TASKS = "Hmm... there are no matching tasks in your list!";

    public static final String MESSAGE_UNDO = "Easy-peasy! The most recent change to your task list has been undone!\n\n";
}
