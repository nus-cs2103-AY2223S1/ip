...
public class Parser {
     ...
     * @throws BestieException If command is invalid.
     */
    public String parseCommand(String command, ToDoList list) throws BestieException {
        ...
        default:
            throw new BestieException(LanguageBank.INVALID_INPUT_ERROR_MESSAGE);
        }
    }
     ...
     * @throws BestieException If command is invalid (eg. list is empty, no argument given, invalid argument).
     */
    private String parseMark(String[] splitCommand, ToDoList list) throws BestieException {
        if (list.getLength() == 0) {
            throw new BestieException(LanguageBank.MARK_DONE_EMPTY_LIST_ERROR_MESSAGE);
        }

        if (splitCommand.length < 2) {
            throw new BestieException(LanguageBank.MARK_DONE_INVALID_INDEX_ERROR_MESSAGE);
        }
        ...
        try {
            ...
            throw new BestieException(LanguageBank.INVALID_ARGUMENT_ERROR_MESSAGE);
        }
     ...
     * @throws BestieException If command is invalid (eg. list is empty, no argument given, invalid argument).
     */
    private String parseUnmark(String[] splitCommand, ToDoList list) throws BestieException {
        if (splitCommand.length < 2) {
            throw new BestieException(LanguageBank.MARK_UNDONE_INVALID_INDEX_ERROR_MESSAGE);
        }

        if (list.getLength() == 0) {
            throw new BestieException(LanguageBank.MARK_UNDONE_EMPTY_LIST_ERROR_MESSAGE);
        }
     ...
     * @throws BestieException If command is invalid (eg. list is empty, no argument given, invalid argument).
     */
    private String parseDelete(String[] splitCommand, ToDoList list) throws BestieException {
        if (splitCommand.length < 2) {
            throw new BestieException(LanguageBank.DELETE_INVALID_INDEX_ERROR_MESSAGE);
        }
        ...
        if (index > list.getLength() || index <= 0) {
            throw new BestieException(LanguageBank.DELETE_EMPTY_LIST_ERROR_MESSAGE);
        }
     ...
     * @throws BestieException If command is invalid (eg. list is empty, no argument given, invalid argument).
     */
    private String parseFind(String[] splitCommand, ToDoList list) throws BestieException {
        if (splitCommand.length < 2) {
            throw new BestieException(LanguageBank.FIND_INVALID_FORMAT_ERROR_MESSAGE);
        }
     ...
     * @throws BestieException If command is invalid (eg. no argument given).
     */
    private String parseTodo(String[] splitCommand, ToDoList list) throws BestieException {
        if (splitCommand.length < 2) {
            throw new BestieException(LanguageBank.TODO_INVALID_FORMAT_ERROR_MESSAGE);
        }
     ...
     * @throws BestieException If command is invalid (eg. no argument given, wrong date-time format).
     */
    private String parseDeadline(String[] splitCommand, ToDoList list) throws BestieException {
        if (splitCommand.length < 2) {
            throw new BestieException(LanguageBank.DEADLINE_INVALID_FORMAT_ERROR_MESSAGE);
        }
        ...
        try {
            ...
            throw new BestieException(exception.getMessage());
        }
     ...
     * @throws BestieException If command is invalid (eg. no argument given, wrong date-time format).
     */
    private String parseEvent(String[] splitCommand, ToDoList list) throws BestieException {
        if (splitCommand.length < 2) {
            throw new BestieException(LanguageBank.EVENT_INVALID_FORMAT_ERROR_MESSAGE);
        }
