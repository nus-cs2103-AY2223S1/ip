...
/**
 * Represents a dialog box consisting of an
...
public class DialogBox extends HBox {
    ...
    /**
     * Returns a DialogBox for KKBot with the given text and image.
     * @param text The response from Duke.
     * @param img The image representing Duke.
     * @return The DialogBox for Duke.
     */
    public static DialogBox getKKBotDialog(String text, Image img) {
