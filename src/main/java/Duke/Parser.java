...
public class Parser {
    ...
    public void parse(String input, Storage storage, TaskList taskList) throws DukeException, IllegalArgumentException {

        if (input.equals("list")) {
            taskList.taskPrinter();
            ...
            if (in.isEmpty()) {
                ...
                if (index >= taskList.getList().size() || index < 0) {
                    ...
                    System.out.println("Now you have " + taskList.getList().size() + " task(s) in the list");
                }
            }
