...
Monke is a monkey themed todo list bot following the open source Duke project template. Monke provides simple task tracking with a monkey twist :D Refer below for the user guide!
