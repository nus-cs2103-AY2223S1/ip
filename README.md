...
1. Download the duke.jar file from release version v0.3
2. Save duke.jar to an empty folder
3. Open terminal and navigate into the folder containing duke.jar
4. Run the following command in terminal: ```java -jar duke.jar```
