...
### `deadline Task_Description /at Deadline` - Add deadline task
...
### `event Task_Description /from Start_time /to End_time` - Add event task
...
### `delete [0, *, Task_Index]` - delete event task
...
### `mark [0, *, Task_Index]` - mark event task
...
Noted. I've marked this task:
 [T][X] task-1
 [T][X] task-2
Now you have XYtasks in the list.
```
...
### `unmark [0, *, Task_Index]` - delete event task
...
Index | Task type | Status | Task details
--- | --- | --- | ---
1 | T | X | task-1
2 | T | X | task-2
3 | T | X | task-3
